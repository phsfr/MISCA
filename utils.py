...
MODEL_CLASSES = {
    ...
    "parsroberta": (RobertaConfig, JointRoberta, RobertaTokenizer),
}

MODEL_PATH_MAP = {
    "lstm": "",
    "roberta": "roberta-base",#r'E:\language_models\roberta_base',#
    "parsroberta": "HooshvareLab/roberta-fa-zwnj-base", #r"E:\language_models\hooshvarelab_roberta_fa_zwnj_base"
}
